...
public class JournalEntryController {
    ...
    public ResponseEntity<?> DeleteJournalEntryById(@PathVariable ObjectId myId){ // ? = wild card pattern (kch bhi return krwa skte h, kisi aur class ka obj bhi return krwa skte h)
        try {
